...
#RIGHT LUNG
        ...
        def test_RIGHTFrontBackMask1OnlyLeftLungMask2(self):
            TRAIN_DIR = 'D:\\Git\\TrainCTRs'
            countNumePozaMask = 0
            countNumePozaMaskO = 0
            countNumePozaMask2 = 0
        ...
        def test_RIGHTFrontBackMask1OnlyLeftLungMask1(self):
            TRAIN_DIR = 'D:\\Git\\TrainCTRs'
            countNumePozaMaskO = 0
            countNumePozaMask1 = 0
            subfolders = [f.path for f in os.scandir(TRAIN_DIR) if f.is_dir()]
        ...
        def test_RIGHTTopBottomMask1OnlyLeftLungMask2(self):
            TRAIN_DIR = 'D:\\Git\\TrainCTRs'
            countNumePozaMask = 0
            countNumePozaMaskO = 0
            countNumePozaMask2 = 0
        ...
        def test_RIGHTTopBottomMask1OnlyLeftLungMask1(self):
            TRAIN_DIR = 'D:\\Git\\TrainCTRs'
            countNumePozaMaskO = 0
            countNumePozaMask1 = 0
            subfolders = [f.path for f in os.scandir(TRAIN_DIR) if f.is_dir()]
        ...
        def test_RIGHTLeftRightMask1OnlyLeftLungMask2(self):
            TRAIN_DIR = 'D:\\Git\\TrainCTRs'
            countNumePozaMask = 0
            countNumePozaMaskO = 0
            countNumePozaMask2 = 0
        ...
        def test_RIGHTLeftRightMask1OnlyLeftLungMask1(self):
            TRAIN_DIR = 'D:\\Git\\TrainCTRs'
            countNumePozaMaskO = 0
            countNumePozaMask1 = 0
            subfolders = [f.path for f in os.scandir(TRAIN_DIR) if f.is_dir()]
