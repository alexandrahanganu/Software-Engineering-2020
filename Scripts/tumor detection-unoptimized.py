...
DATASET_DIR = '/content/drive/My Drive/tbc' # directory with image data
...
def predict_and_plot_differences(dataset, img_id):
    ...
    r = results[0]    
    visualize.display_differences(original_image,gt_box, gt_class_id, gt_mask,r['rois'], r['class_ids'], r['scores'], r['masks'],class_names = ['affected'], title="", ax=get_ax(),show_mask=True, show_box=True)
