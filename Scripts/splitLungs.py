    ...
    if len(os.listdir(dir)) > 0:
        ...
        for file in os.listdir(dir):
            if "CTR" in file:
                ...
                if leftLung.size == (512, 512) and rightLung.size == (512,512):
                    for i in range(512):
                        for j in range(512):
...
def main(director):
    threads = []
    for root, dirs, file in os.walk(director): #To change acording to location on your computer
